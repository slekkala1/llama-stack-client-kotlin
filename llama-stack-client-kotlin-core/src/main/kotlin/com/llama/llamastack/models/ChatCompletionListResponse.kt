...
class ChatCompletionListResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChatCompletionListResponse].
         *
    ...
    /** A builder for [ChatCompletionListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(chatCompletionListResponse: ChatCompletionListResponse) = apply {
            data = chatCompletionListResponse.data.map { it.toMutableList() }
            firstId = chatCompletionListResponse.firstId
            hasMore = chatCompletionListResponse.hasMore
            lastId = chatCompletionListResponse.lastId
            object_ = chatCompletionListResponse.object_
            additionalProperties = chatCompletionListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChatCompletionListResponse].
         *
         ...
         */
        fun build(): ChatCompletionListResponse =
    ...
    fun validate(): ChatCompletionListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                inputMessages = data.inputMessages.map { it.toMutableList() }
                model = data.model
             ...
             *
             * You should usually call [Builder.inputMessages] with a well-typed
             * `List<InputMessage>` value instead. This method is primarily for setting the field to
            ...
            fun addInputMessage(user: InputMessage.User) =
                addInputMessage(InputMessage.ofUser(user))
            ...
            fun addInputMessage(tool: InputMessage.Tool) =
                addInputMessage(InputMessage.ofTool(tool))
        ...
        private constructor(
            ...
            /**
             * An interface that defines how to map each variant of [InputMessage] to a value of
             * type [T].
             */
            interface Visitor<out T> {
                 ...
                 *
                 * An instance of [InputMessage] can contain an unknown variant if it was
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Data && id == other.id && choices == other.choices && created == other.created && inputMessages == other.inputMessages && model == other.model && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() =
            "Data{id=$id, choices=$choices, created=$created, inputMessages=$inputMessages, model=$model, object_=$object_, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ChatCompletionListResponse && data == other.data && firstId == other.firstId && hasMore == other.hasMore && lastId == other.lastId && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ChatCompletionListResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}

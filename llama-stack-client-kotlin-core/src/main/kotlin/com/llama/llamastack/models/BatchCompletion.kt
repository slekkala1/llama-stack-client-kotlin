...
private constructor(
    private val batch: JsonField<List<CompletionResponse>>,
    ...
    private constructor(
        @JsonProperty("batch")
        @ExcludeMissing
        batch: JsonField<List<CompletionResponse>> = JsonMissing.of()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [BatchCompletion].
         *

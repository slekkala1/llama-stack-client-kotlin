...
private constructor(
    ...
    companion object {
        ...
        fun none(): ChatCompletionListParams = builder().build()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ChatCompletionListParams && after == other.after && limit == other.limit && model == other.model && order == other.order && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ChatCompletionListParams{after=$after, limit=$limit, model=$model, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

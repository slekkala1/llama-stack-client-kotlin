...
private constructor(
    private val data: JsonField<List<ProviderInfo>>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<ProviderInfo>> = JsonMissing.of()
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ListProvidersResponse].
         *

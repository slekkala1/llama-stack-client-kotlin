...
private constructor(
    private val data: JsonField<List<ToolGroup>>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<ToolGroup>> = JsonMissing.of()
     ...
     */
    fun data(): List<ToolGroup> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ToolGroup>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListToolGroupsResponse].
         *
    ...
    /** A builder for [ListToolGroupsResponse]. */
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<ToolGroup>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<ToolGroup>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ToolGroup] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ToolGroup) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ListToolGroupsResponse].
         *

...
private constructor(
    private val data: JsonField<List<Tool>>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Tool>> = JsonMissing.of()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListToolsResponse].
         *
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Tool>` value instead. This
        ...
        /**
         * Adds a single [Tool] to [Builder.data].
         *
        ...
        /**
         * Returns an immutable instance of [ListToolsResponse].
         *

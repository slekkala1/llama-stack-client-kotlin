...
private constructor(
    ...
    companion object {
        ...
        fun none(): TelemetryGetTraceParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TelemetryGetTraceParams]. */
        fun builder() = Builder()
    }

    /** A builder for [TelemetryGetTraceParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TelemetryGetTraceParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TelemetryGetTraceParams && traceId == other.traceId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(traceId, additionalHeaders, additionalQueryParams) /* spotless:on */

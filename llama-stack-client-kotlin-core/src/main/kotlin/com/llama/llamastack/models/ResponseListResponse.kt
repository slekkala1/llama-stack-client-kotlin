...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ResponseListResponse].
         *
    ...
    /** A builder for [ResponseListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(responseListResponse: ResponseListResponse) = apply {
            data = responseListResponse.data.map { it.toMutableList() }
            firstId = responseListResponse.firstId
            hasMore = responseListResponse.hasMore
            lastId = responseListResponse.lastId
            object_ = responseListResponse.object_
            additionalProperties = responseListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseListResponse].
         *
         ...
         */
        fun build(): ResponseListResponse =
    ...
    fun validate(): ResponseListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        @JsonProperty("truncation")
        @ExcludeMissing
        fun _truncation(): JsonField<String> = truncation
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                input = data.input.map { it.toMutableList() }
                model = data.model
                object_ = data.object_
                output = data.output.map { it.toMutableList() }
             ...
             * `Input.ofOpenAIResponseOutputMessageWebSearchToolCall(openaiResponseOutputMessageWebSearchToolCall)`.
             */
            fun addInput(
                openaiResponseOutputMessageWebSearchToolCall:
                    Input.OpenAIResponseOutputMessageWebSearchToolCall
            ) =
                addInput(
                    Input.ofOpenAIResponseOutputMessageWebSearchToolCall(
                        openaiResponseOutputMessageWebSearchToolCall
                    )
                )
            ...
            /**
             * Alias for calling [addInput] with
             * `Input.ofOpenAIResponseOutputMessageFileSearchToolCall(openaiResponseOutputMessageFileSearchToolCall)`.
             */
            fun addInput(
                openaiResponseOutputMessageFileSearchToolCall:
                    Input.OpenAIResponseOutputMessageFileSearchToolCall
            ) =
                addInput(
                    Input.ofOpenAIResponseOutputMessageFileSearchToolCall(
                        openaiResponseOutputMessageFileSearchToolCall
                    )
                )
            ...
            /**
             * Alias for calling [addInput] with
             * `Input.ofOpenAIResponseOutputMessageFunctionToolCall(openaiResponseOutputMessageFunctionToolCall)`.
             */
            fun addInput(
                openaiResponseOutputMessageFunctionToolCall:
                    Input.OpenAIResponseOutputMessageFunctionToolCall
            ) =
                addInput(
                    Input.ofOpenAIResponseOutputMessageFunctionToolCall(
                        openaiResponseOutputMessageFunctionToolCall
                    )
                )
            ...
            /**
             * Alias for calling [addInput] with
             * `Input.ofOpenAIResponseInputFunctionToolCallOutput(openaiResponseInputFunctionToolCallOutput)`.
             */
            fun addInput(
                openaiResponseInputFunctionToolCallOutput:
                    Input.OpenAIResponseInputFunctionToolCallOutput
            ) =
                addInput(
                    Input.ofOpenAIResponseInputFunctionToolCallOutput(
                        openaiResponseInputFunctionToolCallOutput
                    )
                )
            ...
            /**
             * Alias for calling [addInput] with
             * `Input.ofOpenAIResponseMessage(openaiResponseMessage)`.
             */
            fun addInput(openaiResponseMessage: Input.OpenAIResponseMessage) =
                addInput(Input.ofOpenAIResponseMessage(openaiResponseMessage))
             ...
             *
             * You should usually call [Builder.truncation] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        internal fun validity(): Int =
            (if (id.asKnown() == null) 0 else 1) +
                ...
                (input.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
        ...
        private constructor(
            ...
            override fun toString(): String =
                when {
                    openaiResponseOutputMessageWebSearchToolCall != null ->
                        "Input{openaiResponseOutputMessageWebSearchToolCall=$openaiResponseOutputMessageWebSearchToolCall}"
                    openaiResponseOutputMessageFileSearchToolCall != null ->
                        "Input{openaiResponseOutputMessageFileSearchToolCall=$openaiResponseOutputMessageFileSearchToolCall}"
                    openaiResponseOutputMessageFunctionToolCall != null ->
                        "Input{openaiResponseOutputMessageFunctionToolCall=$openaiResponseOutputMessageFunctionToolCall}"
                    openaiResponseInputFunctionToolCallOutput != null ->
                        "Input{openaiResponseInputFunctionToolCallOutput=$openaiResponseInputFunctionToolCallOutput}"
                    openaiResponseMessage != null ->
                        "Input{openaiResponseMessage=$openaiResponseMessage}"
                    ...
                    val bestMatches =
                        sequenceOf(
                                ...
                                tryDeserialize(node, jacksonTypeRef<OpenAIResponseMessage>())?.let {
                                    Input(openaiResponseMessage = it, _json = json)
                                },
                            )
                            .filterNotNull()
                    ...
                    when {
                        value.openaiResponseOutputMessageWebSearchToolCall != null ->
                            generator.writeObject(
                                value.openaiResponseOutputMessageWebSearchToolCall
                            )
                        value.openaiResponseOutputMessageFileSearchToolCall != null ->
                            generator.writeObject(
                                value.openaiResponseOutputMessageFileSearchToolCall
                            )
        ...
        private constructor(
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    /**
                     * The JSON schema the response should conform to. In a Python SDK, this is
                     * often a `pydantic` model. Only used for json_schema.
                     */
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Data && id == other.id && createdAt == other.createdAt && input == other.input && model == other.model && object_ == other.object_ && output == other.output && parallelToolCalls == other.parallelToolCalls && status == other.status && text == other.text && error == other.error && previousResponseId == other.previousResponseId && temperature == other.temperature && topP == other.topP && truncation == other.truncation && user == other.user && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(id, createdAt, input, model, object_, output, parallelToolCalls, status, text, error, previousResponseId, temperature, topP, truncation, user, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, input=$input, model=$model, object_=$object_, output=$output, parallelToolCalls=$parallelToolCalls, status=$status, text=$text, error=$error, previousResponseId=$previousResponseId, temperature=$temperature, topP=$topP, truncation=$truncation, user=$user, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseListResponse && data == other.data && firstId == other.firstId && hasMore == other.hasMore && lastId == other.lastId && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseListResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}

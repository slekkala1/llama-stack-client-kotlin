...
class InferenceBatchCompletionParams
private constructor(
    ...
    /** A builder for [InferenceBatchCompletionParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(inferenceBatchCompletionParams: InferenceBatchCompletionParams) = apply {
            body = inferenceBatchCompletionParams.body.toBuilder()
            additionalHeaders = inferenceBatchCompletionParams.additionalHeaders.toBuilder()
            additionalQueryParams = inferenceBatchCompletionParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [InferenceBatchCompletionParams].
         *
         ...
         */
        fun build(): InferenceBatchCompletionParams =
            InferenceBatchCompletionParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(contentBatch, modelId, logprobs, responseFormat, samplingParams, mutableMapOf())
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && contentBatch == other.contentBatch && modelId == other.modelId && logprobs == other.logprobs && responseFormat == other.responseFormat && samplingParams == other.samplingParams && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(contentBatch, modelId, logprobs, responseFormat, samplingParams, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{contentBatch=$contentBatch, modelId=$modelId, logprobs=$logprobs, responseFormat=$responseFormat, samplingParams=$samplingParams, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InferenceBatchCompletionParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "InferenceBatchCompletionParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

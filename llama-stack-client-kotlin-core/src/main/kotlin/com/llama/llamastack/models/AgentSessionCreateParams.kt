...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AgentSessionCreateParams].
         *
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("sessionName", sessionName), additionalProperties.toMutableMap())
        }
         ...
         */
        internal fun validity(): Int = (if (sessionName.asKnown() == null) 0 else 1)

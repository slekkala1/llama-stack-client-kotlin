...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VectorStoreDeleteResponse].
         *
    ...
    /** A builder for [VectorStoreDeleteResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(vectorStoreDeleteResponse: VectorStoreDeleteResponse) = apply {
            id = vectorStoreDeleteResponse.id
            deleted = vectorStoreDeleteResponse.deleted
            object_ = vectorStoreDeleteResponse.object_
            additionalProperties = vectorStoreDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VectorStoreDeleteResponse].
         *
         ...
         */
        fun build(): VectorStoreDeleteResponse =
    ...
    fun validate(): VectorStoreDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VectorStoreDeleteResponse && id == other.id && deleted == other.deleted && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "VectorStoreDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}

...
private constructor(
    private val data: JsonField<List<Benchmark>>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Benchmark>> = JsonMissing.of()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListBenchmarksResponse].
         *
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Benchmark>` value instead.
        ...
        /**
         * Adds a single [Benchmark] to [Builder.data].
         *
        ...
        /**
         * Returns an immutable instance of [ListBenchmarksResponse].
         *

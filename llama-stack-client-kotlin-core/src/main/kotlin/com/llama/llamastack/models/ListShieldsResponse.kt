...
private constructor(
    private val data: JsonField<List<Shield>>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Shield>> = JsonMissing.of()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListShieldsResponse].
         *
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Shield>` value instead.
        ...
        /**
         * Adds a single [Shield] to [Builder.data].
         *
        ...
        /**
         * Returns an immutable instance of [ListShieldsResponse].
         *

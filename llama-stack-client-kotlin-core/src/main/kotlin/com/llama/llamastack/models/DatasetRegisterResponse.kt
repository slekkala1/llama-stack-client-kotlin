...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DatasetRegisterResponse && identifier == other.identifier && metadata == other.metadata && providerId == other.providerId && purpose == other.purpose && source == other.source && type == other.type && providerResourceId == other.providerResourceId && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DatasetRegisterResponse{identifier=$identifier, metadata=$metadata, providerId=$providerId, purpose=$purpose, source=$source, type=$type, providerResourceId=$providerResourceId, additionalProperties=$additionalProperties}"
}

...
private constructor(
    private val data: JsonField<List<ScoringFn>>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<ScoringFn>> = JsonMissing.of()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListScoringFunctionsResponse].
         *
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<ScoringFn>` value instead.
        ...
        /**
         * Adds a single [ScoringFn] to [Builder.data].
         *
        ...
        /**
         * Returns an immutable instance of [ListScoringFunctionsResponse].
         *

...
private constructor(
    ...
    /** A builder for [ToolgroupGetParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(toolgroupGetParams: ToolgroupGetParams) = apply {
            toolgroupId = toolgroupGetParams.toolgroupId
            additionalHeaders = toolgroupGetParams.additionalHeaders.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolgroupGetParams && toolgroupId == other.toolgroupId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(toolgroupId, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ToolgroupGetParams{toolgroupId=$toolgroupId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

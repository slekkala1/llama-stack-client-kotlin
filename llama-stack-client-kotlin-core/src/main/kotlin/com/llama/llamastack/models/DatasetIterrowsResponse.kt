...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatasetIterrowsResponse].
         *
    ...
    /** A builder for [DatasetIterrowsResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DatasetIterrowsResponse].
         *
         ...
         */
        fun build(): DatasetIterrowsResponse =
    ...
    fun validate(): DatasetIterrowsResponse = apply {
        if (validated) {
            return@apply
        }

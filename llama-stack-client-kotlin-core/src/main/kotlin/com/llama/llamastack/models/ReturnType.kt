...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ReturnType].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ReturnType].
         *
        ...
        fun build(): ReturnType =
            ReturnType(checkRequired("type", type), additionalProperties.toMutableMap())
    }

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolGetParams: ToolGetParams) = apply {
            toolName = toolGetParams.toolName
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolGetParams && toolName == other.toolName && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(toolName, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ToolGetParams{toolName=$toolName, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
